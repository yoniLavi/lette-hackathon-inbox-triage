...
import { ArrowLeft, Edit2, Clock, Zap, MapPin, FileText, Send, MoreVertical } from "lucide-react";
import Link from "next/link";
import { getCase, getRelatedEmails, getRelatedTasks } from "@/lib/espo";
import type { CrmCase, CrmEmail, CrmTask } from "@/lib/espo";
                                ...
                                <Card className="shadow-sm border-transparent bg-[#F2F2EC]">
                                    <div className="border-b border-[#0F1016]/5 p-3 px-4 bg-[#0F1016]/5 rounded-t-xl">
                                        <h3 className="font-bold text-[#0F1016] text-[10px] uppercase tracking-[0.2em] flex items-center">
                                            <FileText className="w-3.5 h-3.5 mr-2" /> Related Context
                                        </h3>
                                    </div>
                                    <div className="p-4">
